          ...
          <div class="row">
            <div class="col-12">
              <form class="row g-3 needs-validation" novalidate="" method="POST" action="{{route('userStore')}}" enctype="multipart/form-data">
                @csrf
                <input value="{{$user->id}}" required name="user_id" type="hidden">
                ...
                <div class="col-12 parentClone">
                    <div class="row fh_karakterisitke canClone mixture-0 canClone" data_id="0">
                      <div class="col-xl-6 position-relative">
                        ...
                        <input class="form-control form-input-replace trade_name" value="{{$user->name}}" required id="name" name="name" type="text">
                      </div>
                      <div class="col-xl-6 position-relative">
                        <label class="form-label" for="email">Email</label>
                        <input class="form-control form-input-replace trade_name" value="{{$user->email}}" required id="email" name="email" type="text">
                      </div>
                      <div class="col-xl-6 position-relative">
